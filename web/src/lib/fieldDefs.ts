...
export const FIELD_DEFS: {
  ...
  global: [
    ...
    { num: "07", id: "style",      title: "影像风格",   tags: ["opt"],              dataLayer: "global" },
    { num: "08", id: "characters", title: "角色调用",   tags: ["req"],              dataLayer: "global" },
    { num: "09", id: "story",      title: "故事内容",   tags: ["req"],              dataLayer: "global" },
    { num: "10", id: "imageQuality", title: "画质内容", tags: ["opt"],              dataLayer: "global" },
    { num: "11", id: "ambientSfx", title: "环境音效",   tags: ["opt"],              dataLayer: "output" },
    { num: "12", id: "subtitle",   title: "字幕",       tags: ["opt"],              dataLayer: "output" },
    { num: "13", id: "generateAudio", title: "生成音频", tags: ["opt"],            dataLayer: "output" },
