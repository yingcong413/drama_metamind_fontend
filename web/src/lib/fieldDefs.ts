...
export const FIELD_DEFS: {
  ...
  global: [
    ...
    { num: "14", id: "generateAudio", title: "生成音频", tags: ["opt"],            dataLayer: "output" },
    { num: "15", id: "music",      title: "背景音乐",   tags: ["opt"],              dataLayer: "output" },
    { num: "16", id: "narrationAudio", title: "旁白音频", tags: ["opt", "audio"],   dataLayer: "global" },
  ],
  shot: [
